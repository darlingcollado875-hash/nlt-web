...
(function () {
    ...
    const NLT_API = {
        ...
        communityComentarios: (postId) => requestConSesionOpcional(`/community/posts/${postId}/comments`),
        ...
        communityActualizarComentario: (id, body) => request(`/community/comments/${id}`, { method: 'PATCH', body: JSON.stringify({ body }) }),
